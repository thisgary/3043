...
public class RadioButtonFrame extends JFrame
{
	...
	public RadioButtonFrame()
	{
		...
		add( italicJRadioButton ); // add button to JFrame
		add( boldItalicJRadioButton ); // add bold and italic button
		// create logical relationship between JRadi oButtons
		radioGroup = new ButtonGroup(); // create Buttondroup
	...
	private class RadioButtonHandler implements ItemListener
	{
				...
				{
					font = f; // set the font of this listene	// end constructor RadioButtonHandler
			 ...
			 // private inner class to handle radio button events
					private class RadioButtonHandler1 implements ItemListener
					{
						...
						public void RadioButtonHandler( Font f )
						{
